...
export const metadata: Metadata = {
  title: "Explore Gallery - Discover Amazing Designs & Photos",
  description: "Discover and explore amazing photos, designs, and creative works. Search, filter, and save your favorite items.",
};
